    ...
    <div className="min-h-screen bg-slate-50 p-6">
      <div className="max-w-5xl mx-auto">
        <div className="mb-8">
          ...
          <p className="text-slate-500 mt-1">Academic Coach Portal — Elevate Education Hub</p>
        </div>
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
          {[
            { icon: Users, label: "Assigned Students", value: "—", color: "text-blue-600" },
            { icon: BookOpen, label: "Active Lessons", value: "—", color: "text-green-600" },
            { icon: CheckSquare, label: "Completed This Week", value: "—", color: "text-purple-600" },
        ...
        <div className="mt-8 p-6 bg-white rounded-xl border border-slate-200">
          <p className="text-slate-400 text-center">
            Gradebook, KPIs, and student management will appear here in Phase 8+.
          </p>
        </div>
      </div>
    </div>
