...
import AcademicCoachClasses from "./pages/academic-coach/Classes";
    ...
    <RBACGuard>
      <Routes>
        ...
        <Route element={<PortalLayout />}>
          ...
          <Route path="/academic-coach/classes" element={<AcademicCoachClasses />} />
          ...
          <Route path="/academic-coach/schedule" element={<AcademicCoachClasses />} />
