...
const functions = {
  async invoke(functionName, params = {}) {
    ...
    const fnRoutes = {
      ...
      inviteUser:      () => apiFetch('/users/invite', { method: 'POST', body: JSON.stringify(params) }).then(d => ({ data: d })),
      inviteAndSetRole:() => apiFetch('/users/invite', { method: 'POST', body: JSON.stringify(params) }).then(d => ({ data: d })),
